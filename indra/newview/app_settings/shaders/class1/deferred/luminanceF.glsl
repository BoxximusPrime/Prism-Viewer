...
void main()
{
    if (eye_adaptation != 0)
    {
        // Meter the actual pre-exposure scene, including the screen edges.
        // The stock diffuse/sky bias and glow buffer are deliberately excluded:
        // emissive surfaces already contribute to diffuseRect here.
        vec3 c = texture(diffuseRect, vary_fragcoord).rgb;
