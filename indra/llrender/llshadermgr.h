...
public:
    ...
    {                                       // Shader uniform name, set in LLShaderMgr::initAttribsAndUniforms()
        ...
        SSGI_SOURCE,                        //  "ssgiSource"
        SSGI_GEOMETRY,                      //  "ssgiGeometry"
        SSGI_INDIRECT,                      //  "ssgiIndirect"
        SSGI_HISTORY,                       //  "ssgiHistory"
        SSGI_HISTORY_GUIDE,                 //  "ssgiHistoryGuide"
        TAA_CURRENT,                        //  "taa_current"
        TAA_HISTORY,                        //  "taa_history"
        TAA_DETAIL,                         //  "taa_detail"
        TAA_MOTION,                         //  "taa_motion"
        TAA_OPAQUE,                         //  "taa_opaque"
        TAA_SOURCE,                         //  "taa_source"
        TAA_ORIGINAL,                       //  "taa_original"
        ...
        WATER_WAVE_SLOPES,                  //  "waterWaveSlopes"
        WATER_WAVE_HEIGHTS,                 //  "waterWaveHeights"
        WATER_GEOMETRY_DEPTH,               //  "waterGeometryDepth"
        WATER_WAVE_SPECTRUM,                //  "waterWaveSpectrum"
        ...
        WATER_FOG_SUN_COLOR,                //  "waterFogSunColor"
        WATER_FOG_SKY_COLOR,                //  "waterFogSkyColor"
        WATER_FOG_LIGHT_DIR,                //  "waterFogLightDir"
        WATER_ABSORPTION_COLOR,             //  "waterAbsorptionColor"
        WATER_SCATTERING_COLOR,             //  "waterScatteringColor"
