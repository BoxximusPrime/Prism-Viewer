...
using Record = std::tuple<int, int, U32, float, int, int, std::vector<int>>;
...
def main():
    ...
    print("Passed masked shadow batching: per-index state, 3 to 1 compatible draws, boundaries and platform limits")
